...
import {
  getHiddenMediaStorageInfo,
  clearHiddenMediaStorage,
} from "../../src/utils/localMediaStorage";
import {
  Moon,
  Sun,
  Monitor,
...
export default function SettingsScreen() {
  ...
  const { networkStatus, setNetworkStatus, autoRetry, setAutoRetry } =
    useQueueStore();
        ...
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            ...
            if (success) {
              ...
              Alert.alert(
                "Success",
                "Local media folder cleared successfully!",
              );
            } else {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <Header
        title="Settings"
        subtitle="Preferences, theme & database backups"
      />
      ...
      >
        ...
        <Card style={styles.sectionCard}>
          ...
          <Text style={[styles.sectionSub, { color: colors.textSecondary }]}>
            Select your preferred MD3 interface theme
          </Text>
              ...
              >
                ...
                <Text
                  style={[
                    ...
                    {
                      color:
                        mode === key ? colors.primary : colors.textSecondary,
                    },
                  ]}
                >
                  {label}
        ...
        <Card style={styles.sectionCard}>
          <Text style={[styles.sectionTitle, { color: colors.textPrimary }]}>
            Network & Queue Engine
          </Text>
          <Text style={[styles.sectionSub, { color: colors.textSecondary }]}>
            Test offline behavior and automatic retry rules
          </Text>
          ...
          <View style={styles.optionRow}>
            <View style={styles.optionTextGroup}>
              ...
              <View>
                ...
                >
                  Current: {networkStatus.toUpperCase()}
                </Text>
              </View>
            </View>
          </View>
                  ...
                  styles.netChip,
                  {
                    backgroundColor:
                      networkStatus === net
                        ...
                        : colors.surfaceVariant,
                    borderColor:
                      networkStatus === net ? colors.primary : colors.border,
                  },
                ]}
              >
                <Text
        ...
        <Card style={styles.sectionCard}>
          ...
          <Text style={[styles.sectionSub, { color: colors.textSecondary }]}>
            SQLite database management & JSON export
          </Text>
          ...
          <View style={styles.storageInfo}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text
                style={[styles.optionDesc, { color: colors.textSecondary }]}
              >
                {posts.length} Posts • {campaigns.length} Campaigns • ~1.2 MB
                SQLite
              </Text>
            </View>
          </View>
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              <Text style={[styles.optionTitle, { color: colors.textPrimary }]}>
                Offline Media Directory
              </Text>
              <Text
                style={[styles.optionDesc, { color: colors.textSecondary }]}
              >
                Folder: {folderPath} {"\n"}
                {mediaStorage.fileCount} files •{" "}
                {formatBytes(mediaStorage.sizeBytes)} used
              </Text>
            </View>
          ...
          <View style={styles.backupBtnRow}>
            ...
            >
              ...
              <Text style={[styles.backupText, { color: colors.primary }]}>
                Export JSON
              </Text>
            </TouchableOpacity>
            ...
            >
              ...
              <Text style={[styles.backupText, { color: colors.textPrimary }]}>
                Restore Backup
              </Text>
            </TouchableOpacity>
          </View>
        ...
        <Card style={styles.sectionCard}>
          ...
          <Text style={[styles.sectionSub, { color: colors.textSecondary }]}>
            Schedule alerts and queue updates
          </Text>
            ...
            <View style={styles.optionTextGroup}>
              ...
              <View>
                ...
                <Text
                  style={[styles.optionDesc, { color: colors.textSecondary }]}
                >
                  Notify when post uploads finish or fail
                </Text>
              </View>
            </View>
            <Switch
        ...
        <Card style={styles.sectionCard}>
          ...
          <Text style={[styles.sectionSub, { color: colors.textSecondary }]}>
            Terms of Service, Privacy Policy & Meta Data Rights
          </Text>
        ...
        {typeof window !== "undefined" &&
          !!(window as any).electronAPI?.isElectron && (
            <Card style={styles.sectionCard}>
              ...
              >
                Access Chrome developer logs and inspectors
              </Text>
              ...
              <View style={{ marginTop: 4 }}>
                ...
                >
                  ...
                  <Text
                    style={[styles.backupText, { color: colors.textPrimary }]}
                  >
                    Toggle Developer Tools (Debug)
                  </Text>
                </TouchableOpacity>
              </View>
            </Card>
